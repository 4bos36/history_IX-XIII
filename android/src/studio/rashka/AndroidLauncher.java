...
public class AndroidLauncher extends AndroidApplication implements AdHandler, RewardedVideoAdListener {
	...
	protected void onCreate (Bundle savedInstanceState) {
		...
		MobileAds.initialize(this, "ca-app-pub-4502192705853513~8816712589");
	...
	private void loadVideoAd() {
		if (loadVideo == 3) {
			videoAd.get("HelpRemove").loadAd("ca-app-pub-4502192705853513/7813754229", new AdRequest.Builder().build());
			videoAd.get("Help50").loadAd("ca-app-pub-4502192705853513/7921565434", new AdRequest.Builder().build());
			videoAd.get("HelpTrue").loadAd("ca-app-pub-4502192705853513/7622182531", new AdRequest.Builder().build());
		}
		else if (loadVideo == 0)
			videoAd.get("HelpRemove").loadAd("ca-app-pub-4502192705853513/7813754229", new AdRequest.Builder().build());
		else if (loadVideo == 1)
